...
export const ABI_SKYBRIDGE_V2: AbiItem[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes32', name: 'DestAddr', type: 'bytes32' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'bytes32', name: 'DestAddr', type: 'bytes32' },
  ...
  {
    inputs: [
      { internalType: 'bytes32', name: '_destinationAddressForBTC', type: 'bytes32' },
      {
        components: [
          { internalType: 'address', name: 'fromToken', type: 'address' },
          { internalType: 'address', name: 'toToken', type: 'address' },
