...
it.each<Pick<SkybridgeParams<'swap', 'test'>, 'hash'>>([
  ...
  return expect(result).toMatchObject({
    ...
    addressSwapIn: '0xe06ff2b69b822807b8ac14479ff4386fe051e242',
    amountIn: '0.00098766',
    amountOut: '0.00073568',
    currencyIn: 'sbBTC',
    currencyOut: 'WBTC',
    feeCurrency: 'WBTC',
    feeTotal: '0.00025198',
    hash,
    status: 'SENDING',
    transactionInId: '0x207cb67ff5aa3e435444dd6ffb900232ed2e5abb94c90b4a4b3d7d8e4e5787ce',
